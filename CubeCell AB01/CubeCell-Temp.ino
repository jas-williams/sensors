...
/* OTAA para*/
uint8_t devEui[] = { 0x9B, 0x21, 0xA1, 0x95, 0x21, 0x3C, 0x34, 0xC3 };
uint8_t appEui[] = { 0xE5, 0x32, 0x4F, 0xAE, 0xC8, 0xDC, 0xE7, 0x4E };
uint8_t appKey[] = { 0xBB, 0xEF, 0x77, 0x09, 0xA9, 0x27, 0x9A, 0x54, 0x87, 0x17, 0x5F, 0x76, 0x3D, 0x92, 0xAB, 0xD2 };
